...
function isAdaptiveProjectionSelected() {
    "use strict";
...
function setStandardParallels(projection, lat0) {
    "use strict";
...
function updateSliderEnabledState() {
    "use strict";
    var enabled = false;
